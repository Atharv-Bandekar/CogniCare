...
export default function SettingsSidebar({ 
  ...
  settings, 
  updateSetting,
  language = "English" // ensure we have a fallback
}: SettingsSidebarProps & { language?: string }) {
        ...
        <div className="space-y-8 flex-1">
          ...
          <div className="space-y-3">
            ...
            <div className="flex bg-slate-800 rounded-xl p-1 border border-slate-700">
              {[
                { id: "normal", label: t.sizeNormal, size: "text-sm" },
                { id: "large", label: t.sizeLarge, size: "text-base" },
                { id: "xl", label: t.sizeXL, size: "text-lg" }
              ].map((opt) => (
                <button
                  key={opt.id}
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              {[
                ...
                { speed: 0.8, label: t.speedSlow },
                { speed: 0.6, label: t.speedVerySlow }
              ].map((opt) => (
